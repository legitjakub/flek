...
## Běžná cena přívětivěji — 25. 9. 2026

- Náhled se zástupnými daty (karta nabídky čtvercová i na výšku s dlouhým názvem, karta nad mapou, náhled na mapě, detail s dalšími časy, karta rezervace, úvod) na 375, 390 a 1280 px: bez vodorovného přetečení; všechny prvky `<s>` mají 12 nebo 14 px a barvu čáry šedou (`muted` 50 %) nebo průsvitně bílou na modré ploše, žádná červená. Text přeškrtnuté ceny v kartě rezervace přečte čtečka jako „běžně 640 Kč“. Build a 161 unit testů PASS.
