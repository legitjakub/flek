...
- Neověřeno: `ares-lookup` proti skutečnému ARES (nasadí ho push), skutečný e-mail s podrobnostmi smlouvy (čeká na migraci), `npm run test:acceptance` s platnou verzí podmínek (skript je připravený, podmínky ještě neplatí).
