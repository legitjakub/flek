  ...
  return (
    <section className="rounded-2xl bg-card p-5 shadow-card sm:p-6" aria-labelledby="zvoneni-nadpis">
      ...
      <p className="mt-1 text-sm leading-relaxed text-muted">
        Když přijde žádost o rezervaci a FLEK Partner je otevřený, aplikace zvoní, dokud žádost nepotvrdíte, neodmítnete
        nebo nevyprší. Zvonění jde ztlumit a další žádost zazvoní znovu. Nejlépe funguje na telefonu nebo tabletu, který
        leží u recepce s otevřeným Přehledem. Když je aplikace zavřená, dozví se o žádosti e-mail a telefon, pokud si níž
        zapnete oznámení; oznámení o žádosti zůstane na obrazovce, dokud na něj neklepnete.
      </p>
      ...
      <p className="mt-3 text-xs leading-relaxed text-muted">
        Zvonění hraje přes reproduktor zařízení, zkontrolujte hlasitost. Rozsvícený displej platí, dokud je FLEK Partner
        otevřený; nic se neukládá.
      </p>
    </section>
  );
}
