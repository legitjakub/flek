...
Tyhle podmínky platí pro rezervace přes FLEK na webu www.app-flek.eu a v aplikaci FLEK. Píšeme je srozumitelně; když něco nebude jasné, napiš nám na {{email}}.

## 1. Kdo jsme a co FLEK dělá

FLEK provozuje **{{provozovatel}}**, IČO {{ico}}, místo podnikání {{sidlo}}, podnikatel zapsaný v živnostenském rejstříku (dále „FLEK“ nebo „my“). Kontakt: {{email}}.

FLEK je online tržiště. Podniky (kadeřnictví a holičství, masáže, kosmetika, sport, jóga a wellness) na něm nabízejí volné termíny svých služeb se slevou. Jednomu takovému termínu říkáme **FLEK**.
...
- Platby zpracovává společnost Stripe. Údaje o tvé kartě FLEK nevidí ani neukládá.
- Platbu přijímáme jménem a na účet podniku. Servisní poplatek je úplata FLEKu za zprostředkování.
- Potvrzení o platbě ti pošle Stripe e-mailem. Doklad o poskytnuté službě ti na požádání vydá podnik.
- Dokud aplikace u platby ukazuje upozornění na testovací platby, žádné skutečné peníze se nestrhávají.
...
- **Služba.** Za službu odpovídá podnik. Vadu reklamuj u podniku bez zbytečného odkladu, nejlépe hned na místě. Podnik reklamaci vyřídí nejpozději do 30 dnů.
- Když se s podnikem nedomluvíš nebo nereaguje, napiš nám na {{email}} a pomůžeme.
- **FLEK.** Stížnost na aplikaci, platbu nebo vratku pošli na {{email}}. Odpovíme bez zbytečného odkladu, nejpozději do 30 dnů.

## 9. Mimosoudní řešení sporů a dozor
...
Potvrzení rezervace a zprávy o jejím zrušení, odmítnutí nebo vypršení posíláme **e-mailem vždy**, protože jde o informace o smlouvě. Oznámení na telefonu a zprávy na WhatsApp si zapínáš a vypínáš v Profilu. Obchodní sdělení posíláme jen s tvým souhlasem.

## 12. Pozvánky pro kamarády

Když pozveš kamaráda svým odkazem, zaznamenáme, kdo koho pozval a jestli dokončil první rezervaci. Za pozvání zatím nedáváme odměnu ani kredit.

## 13. Odpovědnost

FLEK neodpovídá za službu, kterou poskytuje podnik. Odpovídá za povinnosti zprostředkovatele z těchto podmínek. Odpovědnost, kterou zákon vyloučit nedovoluje, tím není dotčena. Aplikaci se snažíme udržet v provozu nepřetržitě, krátké výpadky kvůli údržbě ale vyloučit nejde.

## 14. Osobní údaje

Jak s tvými údaji zacházíme, popisují [Zásady ochrany osobních údajů](/soukromi).
...
Podmínky se řídí českým právem. Ochrana, kterou ti dávají kogentní ustanovení spotřebitelského práva, zůstává zachována. Smlouvy uzavíráme v češtině. Tyto podmínky najdeš na www.app-flek.eu/podminky, potvrzení každé rezervace v e-mailu a v sekci Rezervace.
