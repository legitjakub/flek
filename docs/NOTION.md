...
| Testy | 196 unit testů a build (25. 9.), SQL testy potvrzování, WhatsAppu, právního minima a ověřených recenzí/moderace; změny v hostované DB se při SQL testech celé vracejí rollbackem |
...
- [ ] **Dokončit WhatsApp u Meta.** Hotovo 18. 9. (Claude s tvým svolením): podmínky Meta pro WhatsApp odsouhlasené, založený testovací WhatsApp účet s testovacím číslem +1 555 156 7838; Phone Number ID a ID účtu ti Claude napsal do chatu (do repozitáře nepatří). **Stav 24. 9. ve 23:30:** trvalý token systémového uživatele funguje. Claude přihlásil aplikaci FLEK k odběru zpráv, nastavil profil na WhatsAppu (texty, web, e-mail podpory, logo) a uložil číslo FLEKu do aplikace. Všech pět šablon čeká na schválení u Mety (jednu Meta zamítla, má nové znění a je znovu ve schvalování). Zbývá:
  ...
  3. **Proč šablony čekají (zjištěno 25. 9.):** Meta blokuje celý účet, dokud v Meta Business Suite nevyplníš **Informace o firmě** (právní název, země Česko, web https://www.app-flek.eu), nepřidáš **platební metodu** k WhatsApp účtu a neověříš firmu (doklad s IČO). Přesný postup je v `docs/PRED_SPUSTENIM.md`, stav ukazuje administrace v řádku „Účet u Mety“.
  4. Pro skutečné podniky a zákazníky přidat vlastní telefonní číslo (testovací píše jen na 5 čísel ze seznamu „To“).
  5. Až Meta šablony schválí, Claude kanál zpřístupní a ty na telefonu vyzkoušíš „Ověřit ve WhatsAppu“ v Profilu i v Provozovně a zkušební rezervaci. Stav ukáže i administrace (Nastavení → WhatsApp → Zkontrolovat stav).
