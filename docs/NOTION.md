...
| WhatsApp | u Mety platný trvalý token, aplikace FLEK přihlášená k odběru, webhook ověřený, profil s logem, číslo FLEKu uložené; chybí schválení pěti šablon (25. 9. ráno pořád čekají u Mety) a zkouška na telefonu, do té doby je kanál serverově vypnutý a v UI skrytý |
