...
- **Pulzuje i bez zvuku.** Když prohlížeč zvuk ještě blokuje, je oko jediný kanál, takže špendlík pulzuje, dokud žádost není ztlumená. Vlny a paprsky mají rytmus zvonění (2,6 s, akord v 0 a 0,95 s). Animuje se jen `transform` a `opacity`; při omezeném pohybu vše skončí v klidu.
