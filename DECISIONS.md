...
- **Běžná cena u každé ceny, kterou zákazník vidí, kromě špendlíků na mapě.** Sleva je důvod, proč FLEK existuje, a zákazník ji má mít na očích i v náhledu na mapě, u dalších časů, v platebním okně a ve svých rezervacích (tam ze snímku při rezervaci). Vždy stejně (`OriginalPrice`), aby nekonkurovala ceně, kterou zákazník platí; podobu upravuje rozhodnutí „Běžná cena klidně“ níž. Špendlík na mapě ji nenese: druhá částka by ho rozšířila skoro na dvojnásobek (šířka se počítá z délky popisku), rozmístění by dřív přepínalo na malé firemní špendlíky a ceny by zmizely úplně. Běžnou cenu špendlíku říká jeho popis pro čtečku a ukáže ji náhled po klepnutí.
...
## Běžná cena klidně, úspora jako zisk — 25. 9. 2026

- **Šedá tenká čára místo červené.** Červená 2px linka přes šedé číslo o 11–12 px zakrývala číslice a slevu, kvůli které FLEK existuje, podávala jako opravu nebo chybu. Paleta přitom drží slevu modrou právě proto, aby nevypadala jako stav (zelená, jantarová, červená). Běžná cena je teď šedá s tenkou šedou čarou (`decoration-muted/50`, 1,5 px) a nikde menší než 12 px.
- **Slovo „běžně“.** Stejné slovo jako v podmínkách („Běžná cena je cena, za kterou podnik službu běžně nabízí“). Viditelné tam, kde je místo (karta nabídky, detail, platební okno, úvod), jinak jen pro čtečku: ta přeškrtnutí neohlásí a „1 200 Kč 750 Kč“ byly dvě ceny bez významu.
- **Úspora jako malý zisk.** Bublina „ušetříš 450 Kč“ (`SavingPill`) ve světlém odstínu značky, na modré ploše průsvitně bílá: na detailu místo „−38 %“ vedle přeškrtnuté ceny (procenta už jsou na fotce) a v platebním okně. Konkrétní částka je fakt, procenta si člověk přepočítává.
- **Cena, kterou člověk platí, je vždy nejvýraznější.** Na dlaždicích dalších časů byla šedá stejně jako ta přeškrtnutá; teď je tučně inkoustem.
