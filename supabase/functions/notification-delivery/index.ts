...
function emailHtml(title: string, body: string, href: string): string {
  return `<!doctype html><html lang="cs"><body style="margin:0;background:#f6f5f3;color:#17181c;font-family:Arial,sans-serif"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="padding:32px 16px"><tr><td align="center"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:520px;background:#fff;border-radius:24px;padding:32px"><tr><td style="font-size:34px;font-weight:800;letter-spacing:-1.5px">flek<span style="color:#f2703f">′</span></td></tr><tr><td style="padding-top:28px;font-size:24px;font-weight:800">${escapeHtml(title)}</td></tr><tr><td style="padding-top:12px;font-size:16px;line-height:1.55;color:#5e616b">${escapeHtml(body)}</td></tr><tr><td style="padding-top:24px"><a href="https://www.app-flek.eu${href}" style="display:block;border-radius:14px;background:#17181c;padding:15px 20px;color:#fff;text-align:center;font-size:16px;font-weight:700;text-decoration:none">Otevřít rezervace</a></td></tr></table></td></tr></table></body></html>`;
}
